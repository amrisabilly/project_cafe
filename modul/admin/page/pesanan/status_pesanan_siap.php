...
<body style="font-family: 'Inknut Antiqua', serif;">
    <div>
        ...
        <div class="px-4">
            ...
            <a href="status_pesanan_antar.php" class="d-flex rounded-1 justify-content-center align-items-center gap-4 text-black" style="background-color: #73F1A7; width: 88%; position: fixed; bottom: 50px; padding: 0.7em;text-decoration: none;">
                <p class="mb-0 text-center" style="font-size: 16px;">Antarkan Pesanan Sekarang</p>
            </a>
            
            <a href="pesanan_admin.php" class="d-flex rounded-1 justify-content-center align-items-center gap-4 fw-bold" style="background-color: transparent; width: 88%; position: fixed; bottom: 8px; padding: 0.3em;text-decoration: none;">
                <p class="mb-0 text-center" style="font-size: 16px;">Kembali</p>
            </a>
        </div>
