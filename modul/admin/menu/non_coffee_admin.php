...
<body style="font-family: 'Inknut Antiqua', serif;">
    <section class="mb-5">
        ...
        ?>
        <div class="d-flex flex-column justify-content-center align-items-center px-3 gap-3" style="margin-top: 3em;">
            <?php
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $foto = $row['foto'];
            ?>
                <div class="rounded-4 d-flex justify-content-between align-items-center px-4" data-id="<?php echo $id_produk; ?>" data-nama="<?php echo $nama; ?>" data-kategori="<?php echo $kategori; ?>" data-harga="<?php echo $harga; ?>" 
                    data-foto="<?php echo $foto; ?>" style="background-color: #D9D9D9;width: 100%;height: 5em;">
                    ...
                    <div>
                        ...
                        <form action="../../../config/admin/controller_menu.php" method="post" style="display: inline;">
                            ...
                            <input type="hidden" name="halaman" value="Non Coffee">
    ...
    <form action="../../../config/admin/controller_menu.php" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="foto" name="foto_lama" value="<?php echo $foto ?>" required/>
        <input type="hidden" name="halaman" value="Non Coffee" hidden required/>
