...
<body style="font-family: 'Inknut Antiqua', serif;">
    <section class="mb-5">
        <div class="d-flex justify-content-center align-items-center"
            style="background-color: #D9D9D9;width: 100%;height: 5em;margin-top: 3em;margin-bottom: 0.5em;">
        ...
        <div class="d-flex justify-center align-items-center p-4" style="width: 100%;">
            <div class="d-flex justify-center align-items-center rounded-3"
                style="background-color: #B7DBFD;width: 100%;height: 3em;">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center px-3 gap-3">
            <div class="rounded-4 d-flex justify-content-between align-items-center px-4"
                style="background-color: #D9D9D9;width: 100%;height: 5em;">
                <div class="d-flex justify-content-between align-items-center gap-3">
                    <img src="../../../public/admin/unnamed.jpg" alt="" class="rounded-3"
                ...
                <div>
                    <button style="border: none; background-color: transparent;">
                        <img src="../../../public/admin/Trash.png" alt="" class="rounded-3"
                            style="width: 26px;height: 29px;">
                    </button>
                    <button class="edit" style="border: none; background-color: transparent;">
                        <img src="../../../public/admin/Edit.png" alt="" class="rounded-3"
                            style="width: 26px;height: 29px;">
                    </button>
                </div>
            </div>
    ...
    <div class="tombol d-flex justify-content-between align-items-center"
        style="background-color: #AF5C5C; position: fixed; bottom: 0; width: 100%; height: 4em; padding: 2em;">
        <a href="menu_admin.php" class="fw-bold text-black" id="backButton"
            style="background-color: transparent;border: none;font-size: 15px;text-decoration: none;">
            <img src="../../../public/admin/kembali.png" alt="kembali">
            Kembali</a>
    </div>

    <!-- Form Edit -->
    <div id="formContainerEdit" class="form"
        style="background-color: #AF5C5C; position: fixed; bottom: 0; width: 100%; height: 35em; padding: 2em; display: none; border-top-left-radius: 1.5rem; border-top-right-radius: 1.5rem; font-size: 14px;">
        <div
            style="background-color: #EAABAB; height: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column; gap: 0.6em; border-radius: 1.5rem;">
            <!-- Preview Gambar -->
            <div
                style="width: 70px; height: 70px; border-radius: 8px; border: 1px solid #ccc; display: flex; overflow: hidden; background-color: #f8f8f8;align-self: flex-start; margin-left: 10%;">
                <img id="imagePreviewEdit" src="#" alt="Preview Gambar"
                    style="width: 100%; height: 100%; object-fit: cover; display: none;" />
            </div>

            <!-- Input File -->
            <form action="../../../config/admin/edit_menu.php" method="post">
                <input id="imageInputEdit" type="file" accept="image/*"
                    style="border-radius: 5px; align-self: flex-start; margin-left: 10%; border: none; visibility: hidden;" />
                <label for="imageInputEdit" class="text-black"
                    style="cursor: pointer; color: white; background-color: #ffffff; padding: 5px 10px; border-radius: 5px; font-size: 14px;align-self: flex-start; margin-left: 10%;">Pilih
                    Gambar</label>
                ...
                <input type="number" placeholder="Rp. "
                    style="padding: 5px; width: 80%; border-radius: 5px; border: none;" />

                <div class="d-flex justify-content-between align-items-center" style="width: 80%; margin-top: 1em;">
                    <button id="cancelEditButton" type="reset" class="rounded-3 p-1" style="background-color: #AF5C5C;">Kembali</button>
