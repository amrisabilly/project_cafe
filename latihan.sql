...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Bulan Mei 2025 pada 21.03
...
(2, 'bimak', 'Main Course', 'public/admin/mitigasi 1.jpg', 123),
...
ALTER TABLE `detail_transaksi`
  ...
  ADD CONSTRAINT `detail_transaksi_ibfk_2` FOREIGN KEY (`produk_id`) REFERENCES `menu` (`id_produk`);
